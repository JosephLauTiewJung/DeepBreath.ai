...
import { funFacts} from "../data/FunFacts.jsx";

const STATUS_MESSAGES = [
    "Initializing secure connection...",
    "Parsing raw data streams...",
    "Applying neural analysis...",
    "Synthesizing insights...",
    "Generating visual reports...",
    "Finalizing your personalized summary..."
];
        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-6 overflow-hidden relative">
            ...
            <div className="w-full max-w-2xl z-10">
                ...
                >
                    ...
                    <h1 className="text-3xl font-semibold tracking-tight mb-2">Generating Your Report</h1>
